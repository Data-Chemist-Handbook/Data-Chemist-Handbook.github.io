...
| attention            | a mechanism to determine the importance of components in a sequence relative to other components in taht sequence, allowing the model to pay attention to the most relevant parts of the sequence. |
