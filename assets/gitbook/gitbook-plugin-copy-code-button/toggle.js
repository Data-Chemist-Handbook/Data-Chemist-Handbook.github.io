require(["gitbook", "jquery"], function (gitbook, $) {
    ...
    gitbook.events.bind("page.change", function () {
        $("pre").each(function () {
            ...
            $copyCodeButton.css({ "position": "absolute", "top": "5px", "right": "5px", "padding": "3px", "background-color": "#b8c9cc", "color": "#3f3e3e", "border-radius": "5px", "-moz-border-radius": "5px", "-webkit-border-radius": "5px", "border": "2px solid #3f3e3e" });
